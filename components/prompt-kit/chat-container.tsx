...
// useAutoScroll hook remains unchanged
const useAutoScroll = (
...
// Updated ChatContainerProps type
export type ChatContainerProps = {
  children: React.ReactNode;
  className?: string;
  autoScroll?: boolean;
  scrollToRef?: React.RefObject<HTMLDivElement>;
  ref?: React.Ref<HTMLDivElement>; // Changed to React.Ref for compatibility
...
function ChatContainer({
  ...
  const chatContainerRef = ref || containerRef; // Note: ref might be a callback or string in some cases
